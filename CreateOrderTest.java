...
@ActiveProfiles("test") //loads up H2 database
@Sql(scripts = {
    "classpath:flyway/migrations/V1.0__Jeep_Schema.sql", //creates tables
    "classpath:flyway/migrations/V1.1__Jeep_Data.sql"}, //populates tables
...
class CreateOrderTest {
  ...
  void testCreateOrderReturnsSuccess201() {
    ...
    String uri = String.format("http://localhost:%dorders", serverPort);
    ...
    //constructor - pass in body into the constructor
